    ...
    <div>
      <div>
        ...
        <Routes>
          ...
          <Route path="/my-meetings" element={user ? <MyMeetingsPage /> : <Navigate to="/login" />} />
          ...
          <Route path="/schedule-meeting/seller/:productId" element={user?<SellerScheduleMeetingPage />:<Navigate to="/" />} />
          <Route
            path="/signup"
