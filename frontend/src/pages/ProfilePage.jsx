          ...
          <div className="flex flex-wrap gap-3">
            ...
            {canViewSellerReviews && (
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl shadow-md transition"
              >
                <Star size={18} />
                {showReviews ? "Hide Seller Reviews" : "View Seller Reviews"}
              </button>
            )}
          </div>
